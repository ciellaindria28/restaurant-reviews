...
# restaurant_reviews_nlp documentation build
...
from restaurant_reviews_nlp import __version__ as release

# -- Project information -----------------------------------------------------

project = "restaurant_reviews_nlp"
author = "Kedro"
...
htmlhelp_basename = "restaurant_reviews_nlpdoc"
...
latex_documents = [
    (
        master_doc,
        "restaurant_reviews_nlp.tex",
        "restaurant_reviews_nlp Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "restaurant_reviews_nlp",
        "Project restaurant_reviews_nlp codebase.",
        "Data-Science",
    )
]
